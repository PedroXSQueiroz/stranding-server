...
CREATE TABLE stranding_user_permission(
	stranding_user_permission_id uuid not null,
	stranding_user_id uuid not null,
	stranding_user_permission_name varchar(256) not null
);

ALTER TABLE stranding_user_permission
	ALTER COLUMN stranding_user_id
	  SET DEFAULT random_uuid();
